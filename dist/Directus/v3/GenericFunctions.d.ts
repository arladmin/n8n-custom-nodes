...
export declare function directusApiAssetRequest(this: IExecuteFunctions | IExecuteSingleFunctions, method: IHttpRequestMethods, path: string, ID: string, dataPropertyName: string, qs?: IDataObject): Promise<any>;
export declare function directusApiFileRequest(this: IExecuteFunctions | IExecuteSingleFunctions | IWebhookFunctions, method: IHttpRequestMethods, path: string, formData?: any, body?: any, qs?: IDataObject, uri?: string, option?: IDataObject): Promise<any>;
